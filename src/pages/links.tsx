...
const Links: NextPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>Jorge Marcos - Links</title>
      </Head>
      <div className="container mx-auto w-full max-w-4xl py-8 text-center md:py-20">
        <div className="relative mx-auto aspect-square w-32 overflow-hidden rounded-full outline-primary md:w-52">
          <Image
            src="https://github.com/ItsJorgeMarcos.png"
            layout="fill"
            alt="Jorge Marcos Carrero"
          />
        </div>
        ...
        <div className="flex flex-col flex-wrap gap-14 py-10 font-mono text-lg font-bold tracking-wider md:flex-row md:text-2xl">
          {linkTree.map((link) => {
