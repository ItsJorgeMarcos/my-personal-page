    ...
    return (
      <Html lang="es">
        <Head>
          ...
          <meta
            name="description"
            content="Yo soy Jorge Marcos. Desarrollador Fullstack de España. Me gusta jugar con Css. Mi Stack de desarrollo es Html, CSS, JS, TS, React, NEXT.JS, Tailwindcss, Scss."
          />
